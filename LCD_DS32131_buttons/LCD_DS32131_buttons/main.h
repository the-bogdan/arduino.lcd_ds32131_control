...
//-------------------------------------------------------------------------------------------------------------------
#include "LCD.h" // Подключаем библиотеку работы с LCD
//===================================================================================================================
typedef unsigned char byte;  // Дадим имя byte типу usigned char, чтобы писать было короче
typedef unsigned int uint;  // Тоже самое для unsigned int
//===================================================================================================================
